...
\--- /hint \--- \--- hint \--- Овако би требао да изгледа твој код: ![stage](images/stage.png)
...
\--- task \--- Испробај свој код. Can you hear that a note is repeatedly played when you hold down a key?
