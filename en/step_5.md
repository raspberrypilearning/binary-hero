...
--- task ---
Add code to create a 'note' sprite clone for every note that needs to be played. Each clone should be created two seconds before its note needs to be played. This gives the clone two seconds to move down the screen. You'll create the code to move your clones in a little bit!
