...
All of this code should be repeated `forever`{:class="block3control"}. \--- /hint \--- \--- hint \--- Here are the code blocks you need, and you have to add some of them more than once: ![oder](images/stage.png)
...
\--- /hint \--- \--- hint \--- Tvoja koda bi morala izgledati tako: ![oder](images/stage.png)
