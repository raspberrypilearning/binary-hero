...
\--- /hint \--- \--- hint \--- Εδώ είναι τα μπλοκ που θα χρειαστείς:![φάση](images/stage.png)
...
\--- task \--- Δοκίμασε τον κώδικα. Can you hear that a note is repeatedly played when you hold down a key?
