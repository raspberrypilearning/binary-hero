...
![Add notes and times to lists](images/lists-add-annotated.png) \--- /task \---
...
![Bar sprite costumes](images/note-costumes.png) \--- /task \---
...
\--- /hint \--- \--- hint \--- Εδώ είναι τα μπλοκ που θα χρειαστείς:![note](images/note-sprite.png)
...
\--- /hint \--- \--- hint \--- Έτσι πρέπει να μοιάζει με ο κώδικάς σου:![note](images/note-sprite.png)
