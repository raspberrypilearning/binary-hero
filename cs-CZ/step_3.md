...
All of this code should be repeated `forever`{:class="block3control"}. \--- /hint \--- \--- hint \--- Here are the code blocks you need, and you have to add some of them more than once: ![scéna](images/stage.png)
...
\--- /hint \--- \--- hint \--- This is what your code should look like: ![scéna](images/stage.png)
