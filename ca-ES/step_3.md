...
All of this code should be repeated `forever`{:class="block3control"}. \--- /hint \--- \--- hint \--- Here are the code blocks you need, and you have to add some of them more than once: ![escenari](images/stage.png)
...
\--- /hint \--- \--- hint \--- Això és el que hauria de tenir el vostre codi: ![escenari](images/stage.png)
